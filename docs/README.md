...
- **Broken links and duplicate re-publication:** URLs moved or expired between collection passes, and aggregators re-published the same PSA under different links, producing duplicate and near-duplicate content that had to be detected and de-duplicated after merging.
